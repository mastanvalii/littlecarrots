...
public class ComboFullDetailsBean implements Serializable{
	...
	private List<CombosProductdetailsBean>  comboproddetails;
...
// 			String genderid, List<CombosProductdetailsBean> comboproddetails) {
// 		super();
...
// 	}
	...
	public List<CombosProductdetailsBean> getComboproddetails() {
		return comboproddetails;
	}
	public void setComboproddetails(List<CombosProductdetailsBean> comboproddetails) {
		this.comboproddetails = comboproddetails;
	}
	@Override
