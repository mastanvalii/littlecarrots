...
public class ReceiptBean implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5030140138928982319L;
...
// 	}
	...
	public String toString() {
		return "ReceiptBean [invoiceid=" + invoiceid + ", soldfrom=" + soldfrom + ", orderid=" + orderid
				...
				+ ", soldProducts=" + soldProducts + ", shippingcharges=" + shippingcharges + ", shippingtaxamount="
				+ shippingtaxamount + ", shippingtotalamount=" + shippingtotalamount + "]";
	}
